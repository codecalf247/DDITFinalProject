    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="fileUploadForm" action="${pageContext.request.contextPath}/main/tuploadFile" method="post" enctype="multipart/form-data">
                    <input type="hidden" id="folderNoInput" name="folderNo" value="0">
                    <input type="hidden" id="upperFolderInput" name="upperFolder">
                    <input type="hidden" id="folderTyInput" name="folderTy" value="10002">
...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
			<div class="card-body px-4 py-3">
				<div class="row align-items-center">
					...
					<div class="col-9">
						<h4 class="fw-semibold mb-8">팀별 자료실</h4>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li class="breadcrumb-item">
                                                    <a href="${pageContext.request.contextPath}/main/teamlibrary?upperFolder=${pathFolder.folderNo}" class="text-muted text-decoration-none">
                                                        ${pathFolder.folderName}
                                                    </a>
                                                </li> 
                                                &nbsp;&nbsp;>&nbsp;
 ...
 <div class="text-end mb-2">
    <small>팀별 자료실 용량: <strong>${totalSize} / ${totalCapacity}</strong></small>
</div>
  ...
  <div class="w-100 d-inline-block">
        <div class="float-start">
            <c:if test="${fn:length(pathList) > 1}">
                ...
                <a href="${pageContext.request.contextPath}/main/teamlibrary?upperFolder=${parentFolder.folderNo}" 
        ...
        <form id="searchForm" action="${pageContext.request.contextPath}/main/teamlibrary" method="get" class="d-flex align-items-center me-2">               
                <div class="btn-group">
...
<div class="row g-3" id="fileArea">
    <c:forEach var="folder" items="${folders}">
        <div class="col-md-3">
            ...
            ${folder.empNm}<br/>
                <small class="text-muted">${folder.folderCrtYmd}
                </small>
               <%-- 파일 소유자와 로그인한 사용자가 같을 때만 점 3개 버튼 표시 --%>
               <c:if test="${folder.empNo eq member.empNo}">
        ...
        <div class="col-md-3">
            <div class="file-card" draggable="true" data-file-no="${file.fileNo}">
              <a href="${pageContext.request.contextPath}/main/downloadFile/${file.fileNo}">
                ...
                <small class="text-muted">${file.fileReg_Dt}${file.empNm}<br/>${file.fileFancysize}</small>
                <%-- 파일 소유자와 로그인한 사용자가 같을 때만 점 3개 버튼 표시 --%>
                <c:if test="${file.empNo eq member.empNo}">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        currentFolderNo = folderParam ? parseInt(folderParam) : 2; 
        ...
        document.querySelectorAll(".folder-card").forEach(folder => {
            folder.addEventListener("click", (e) => {
                ...
                if (!isDeleteButton) {
                    ...
                    window.location.href = '${pageContext.request.contextPath}/main/teamlibrary?upperFolder=' + selectedFolderNo;
                }
            });
        });
        ...
        function moveItem(type, itemId, targetFolderNo, targetFolderName) {
            const actionUrl = "${pageContext.request.contextPath}/main/tmoveItem";
...
<script>
	...
	document.getElementById("uploadBtn").addEventListener("click", function() {
	    ...
	    const actionUrl = typeFile.checked ? "${pageContext.request.contextPath}/main/tuploadFile" : "${pageContext.request.contextPath}/main/tuploadFolder";
    ...
    function updateForm() {
        if (typeFile.checked) {
            fileUploadForm.action = "${pageContext.request.contextPath}/main/tuploadFile";
            ...
            fileUploadForm.action = "${pageContext.request.contextPath}/main/tuploadFolder";
   ...
   fileUploadInput.addEventListener('change', (e) => {
    ...
    if (file) {
        ...
        const maxLength = 20; // 최대 글자 수 (원하는 길이로 조정)
        ...
        if (fileName.length > maxLength) {
            ...
            // 앞부분 잘라내고 ... + 확장자
            fileName = namePart.substring(0, maxLength - ext.length - 3) + "..." + ext;
        }
    ...
    function deleteFolder(folderNo) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('${pageContext.request.contextPath}/main/tdeleteFolder', {
                    method: 'POST',
 ...
 // 파일 삭제 함수
    function deleteFile(fileNo) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('${pageContext.request.contextPath}/main/tdeleteFile', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                    body: 'fileNo=' + fileNo
                })
