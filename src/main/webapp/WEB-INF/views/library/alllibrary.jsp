    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="fileUploadForm" action="${pageContext.request.contextPath}/main/auploadFile" method="post" enctype="multipart/form-data">
                    <input type="hidden" id="folderNoInput" name="folderNo" value="0">
                    <input type="hidden" id="upperFolderInput" name="upperFolder">
                    <input type="hidden" id="folderTyInput" name="folderTy" value="10003">
...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
			<div class="card-body px-4 py-3">
				<div class="row align-items-center">
					...
					<div class="col-9">
						<h4 class="fw-semibold mb-8">전사 자료실</h4>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <li class="breadcrumb-item">
                                                    <a href="${pageContext.request.contextPath}/main/alllibrary?upperFolder=${pathFolder.folderNo}" class="text-muted text-decoration-none">
                                                        ${pathFolder.folderName}
                                                    </a>
                                                </li> 
                                                &nbsp;&nbsp;>&nbsp;
  ...
  <div class="w-100 d-inline-block">
        <div class="float-start">
            <c:if test="${fn:length(pathList) > 1}">
                ...
                <a href="${pageContext.request.contextPath}/main/alllibrary?upperFolder=${parentFolder.folderNo}" 
        ...
        <form id="searchForm" action="${pageContext.request.contextPath}/main/alllibrary" method="get" class="d-flex align-items-center me-2">               
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        currentFolderNo = folderParam ? parseInt(folderParam) : 3; 
        ...
        document.querySelectorAll(".folder-card").forEach(folder => {
            folder.addEventListener("click", (e) => {
                ...
                if (!isDeleteButton) {
                    ...
                    window.location.href = '${pageContext.request.contextPath}/main/alllibrary?upperFolder=' + selectedFolderNo;
                }
            });
        });
        ...
        function moveItem(type, itemId, targetFolderNo, targetFolderName) {
            const actionUrl = "${pageContext.request.contextPath}/main/amoveItem";
...
<script>
	...
	document.getElementById("uploadBtn").addEventListener("click", function() {
	    ...
	    const actionUrl = typeFile.checked ? "${pageContext.request.contextPath}/main/auploadFile" : "${pageContext.request.contextPath}/main/auploadFolder";
    ...
    function updateForm() {
        if (typeFile.checked) {
            fileUploadForm.action = "${pageContext.request.contextPath}/main/auploadFile";
            ...
            fileUploadForm.action = "${pageContext.request.contextPath}/main/auploadFolder";
    ...
    function deleteFolder(folderNo) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('${pageContext.request.contextPath}/main/adeleteFolder', {
                    method: 'POST',
 ...
 // 파일 삭제 함수
    function deleteFile(fileNo) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch('${pageContext.request.contextPath}/main/adeleteFile', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                    body: 'fileNo=' + fileNo
                })
...
function restoreFile(fileNo) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch('${pageContext.request.contextPath}/main/arestoreFile', {
                method: 'POST',
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                body: 'fileNo=' + fileNo
            })
    ...
    function restoreFolder(folderNo) {
      fetch("${pageContext.request.contextPath}/main/arestoreFolder", {
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
        body: "folderNo=" + folderNo
      })
