	...
	<div class="container-fluid">
					...
					<div class="col-9">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">
									<a class="text-muted text-decoration-none" href="${pageContext.request.contextPath}/boards/complaintboardlist">ComplaintBoard</a></li> 
								<li class="breadcrumb-item active" aria-current="page">ComplaintBoardDetail</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="card">
			<div class="card-body p-4">
													...
													<c:when test="${fn:startsWith(fileMime, 'image')}">
														...
														<div
															...
															<a href="#" data-bs-toggle="modal" data-bs-target="#imageModal" 
																data-image-src="${pageContext.request.contextPath}/boards/complaintboarddisplayFile?fileName=${fileVO.savedNm}" 
																data-image-alt="${fileVO.originalNm}"> 
																<img src="${pageContext.request.contextPath}/boards/complaintboarddisplayFile?fileName=${fileVO.savedNm}" style="max-width: 100%; max-height: 100%; object-fit: contain;" alt="${fileVO.originalNm}">
															</a>
														</div>
													</c:when>
													<c:otherwise>
				...
				<form id="deleteForm" action="${pageContext.request.contextPath}/boards/complaintboarddelete" method="post" style="display: none;">
    			<input type="hidden" name="boNo" id="deleteBoNo">
				</form>
					<a href="${pageContext.request.contextPath}/boards/complaintboardlist" 
						class="btn btn-primary">목록으로</a> 
				<c:if test="${member.empNo eq board.empNo or member.empNo == '202508001'}">
				    <a href="${pageContext.request.contextPath}/boards/complaintboardupdate?boNo=${board.boardNo}"
