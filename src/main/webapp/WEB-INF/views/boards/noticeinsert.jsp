	...
	<div class="container-fluid">
				...
				<div class="row align-items-center">
					<div class="col-9">
						<h4 class="fw-semibold mb-8">
							<c:choose>
								<c:when test="${empty board.boardNo}">공지사항 등록</c:when>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a
									...
									href="${pageContext.request.contextPath}/boards/list">Board</a>
								</li>
							</ol>
						</nav>
					</div>
		...
		<div class="card">
			<div class="card-body p-4">
				<h5 class="card-title fw-semibold mb-4">
					<c:choose>
						<c:when test="${empty board.boardNo}">새 공지사항 작성</c:when>
						<c:otherwise>공지사항 수정하기</c:otherwise>
					</c:choose>
				</h5>

				<form
					action="${pageContext.request.contextPath}/boards/${empty board.boardNo ? 'insert' : 'update'}"
					...
					<div class="mb-3 form-check">
						<input type="checkbox" class="form-check-input" id="imprtncTagYn"
							name="imprtncTagYn" value="Y"
							<c:if test="${board.imprtncTagYn eq 'Y'}">checked</c:if>>
						<label class="form-check-label" for="imprtncTagYn">중요 공지사항</label>
					</div>
				...
				<!-- 작성자 -->
					...
					<!-- 공지사항 유형 -->
					<input type="hidden" name="boardTy" value="02001">
                           	 ...
                           	 <c:choose>
                            	    <c:when test="${fn:startsWith(fileMime, 'image')}">
														...
														<div
															...
															<img
																src="${pageContext.request.contextPath}/boards/displayFile?fileName=${fileVO.savedNm}"
		...
		<div class="d-flex justify-content-end gap-2">
			...
			<button type="button" class="btn btn-outline-secondary"
				onclick="location.href='${pageContext.request.contextPath}/boards/noticelist'">취소</button>
