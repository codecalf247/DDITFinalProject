					...
					<div
						...
						<div class="card-body px-4 py-3">
							<div class="row align-items-center">
								<div class="col-9">
									<h4 class="fw-semibold mb-8">결재완료</h4>
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item" aria-current="page">completedApproval</li>
										</ol>
									</nav>
								</div>
								<div class="col-3"></div>
											...
											<div class="row">
												<div
													...
													<div class="d-flex flex-wrap gap-2 align-items-center">
														<form id="searchForm"
															action="${pageContext.request.contextPath}/eApproval/completed"
												...
												<div class="table-responsive">
													<table class="table align-middle table-hover">
														...
														<tbody>
															...
															<c:forEach items="${sanctnDocList }"
																var="completedSanctnDoc">
																<tr data-sanctnNo="${completedSanctnDoc.sanctnDocNo}">
																	<td>${completedSanctnDoc.sanctnDocNo }</td>
																	<td><c:if
																			test="${completedSanctnDoc.emrgncyYn eq 'Y' }">
																			<span class="mb-1 badge text-bg-danger">긴급</span>
																		</c:if> <a
																		href="${pageContext.request.contextPath }/eApproval/detail/${completedSanctnDoc.sanctnDocNo}?drafterId=${completedSanctnDoc.empNo}">
																			${completedSanctnDoc.sanctnTitle } </a></td>
																	<td><i class="ti ti-user fs-4 me-1"></i>${completedSanctnDoc.empNm }
																	</td>
																	<td>${completedSanctnDoc.deptNm }</td>
																	<td>${fn:substring(completedSanctnDoc.wrtDt, 0, 4) }-
																		${fn:substring(completedSanctnDoc.wrtDt, 5, 7) }-
																		${fn:substring(completedSanctnDoc.wrtDt, 8, 10) }</td>
																	<td><div class="mb-1 badge text-bg-success"
																			id="restore">완료</div></td>
																	<td><c:choose>
																			<c:when test="${completedSanctnDoc.hasFile eq 'Y' }">
