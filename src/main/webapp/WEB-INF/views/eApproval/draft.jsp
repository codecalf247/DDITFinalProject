					...
					<div
						...
						<div class="card-body px-4 py-3">
							<div class="row align-items-center">
								<div class="col-9">
									<h4 class="fw-semibold mb-8">임시저장</h4>
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item" aria-current="page">drafts</li>
										</ol>
									</nav>
								</div>
								<div class="col-3"></div>
											...
											<div class="row">
												<div
													...
													<div class="d-flex flex-wrap gap-2 align-items-center">
														<form id="searchForm"
															action="${pageContext.request.contextPath}/eApproval/draft"
												...
												<div class="table-responsive">
													<table class="table align-middle table-hover">
														...
														<tbody>
															...
															<c:forEach items="${sanctnDocList }" var="draftSanctnDoc">
																<tr data-sanctnNo="${draftSanctnDoc.sanctnDocNo}">
																	<td>${draftSanctnDoc.sanctnDocNo }</td>
																	<td><c:if test="${draftSanctnDoc.emrgncyYn eq 'Y' }">
																			<span class="mb-1 badge text-bg-danger">긴급</span>
																		</c:if> <a
																		href="${pageContext.request.contextPath }/eApproval/register/${draftSanctnDoc.sanctnDocNo}">
																			${draftSanctnDoc.sanctnTitle } </a></td>
																	<td><i class="ti ti-user fs-4 me-1"></i>${draftSanctnDoc.empNm }
																	</td>
																	<td>${draftSanctnDoc.deptNm }</td>
																	<td>${fn:substring(draftSanctnDoc.wrtDt, 0, 4) }-
																		${fn:substring(draftSanctnDoc.wrtDt, 5, 7) }-
																		${fn:substring(draftSanctnDoc.wrtDt, 8, 10) }</td>
																	<td>
																		<c:if test="${draftSanctnDoc.docProcessSttus eq '09005'}">
																			<div class="mb-1 badge text-bg-secondary">임시저장</div>
																		</c:if>
																	</td>
																	<td>
																		<c:choose>
																			<c:when test="${draftSanctnDoc.hasFile eq 'Y' }">
