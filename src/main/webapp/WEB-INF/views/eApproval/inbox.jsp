          ...
          <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">수신결재</h4>
											...
											<div class="row">
												<div
													...
													<div class="d-flex flex-wrap gap-2 align-items-center">
														<form id="searchForm"
															action="${pageContext.request.contextPath}/eApproval/inbox"
												...
												<div class="table-responsive">
													<table class="table align-middle table-hover">
														...
														<tbody>
															...
															<c:forEach items="${sanctnDocList }" var="inboxSanctnDoc">
																<tr>
																	<td>${inboxSanctnDoc.sanctnDocNo }</td>
																	<td><c:if test="${inboxSanctnDoc.emrgncyYn eq 'Y' }">
																			<span class="mb-1 badge text-bg-danger">긴급</span>
																		</c:if> 
																		<a href="${pageContext.request.contextPath }/eApproval/detail/${inboxSanctnDoc.sanctnDocNo}?drafterId=${inboxSanctnDoc.empNo}">
																			${inboxSanctnDoc.sanctnTitle } </a>
																	</td>
																	<td><i class="ti ti-user fs-4 me-1"></i>${inboxSanctnDoc.empNm }
																	</td>
																	<td>${inboxSanctnDoc.deptNm }</td>
																	<td>${fn:substring(inboxSanctnDoc.wrtDt, 0, 4) }-
																		${fn:substring(inboxSanctnDoc.wrtDt, 5, 7) }-
																		${fn:substring(inboxSanctnDoc.wrtDt, 8, 10) }</td>
																	<td>
																		<c:if test="${inboxSanctnDoc.docProcessSttus eq '09002'}">
																			<div class="mb-1 badge text-bg-secondary">진행중</div>
																		</c:if>
																	</td>
																	<td>
																		<c:choose>
																			<c:when test="${inboxSanctnDoc.hasFile eq 'Y' }">
