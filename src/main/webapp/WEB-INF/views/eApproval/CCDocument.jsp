					...
					<div
						...
						<div class="card-body px-4 py-3">
							<div class="row align-items-center">
								<div class="col-9">
									<h4 class="fw-semibold mb-8">수신참조</h4>
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item" aria-current="page">CC
												Document</li>
										</ol>
									</nav>
								</div>
											...
											<div class="row">
												<div
													...
													<div class="d-flex flex-wrap gap-2 align-items-center">
														<form id="searchForm"
															action="${pageContext.request.contextPath}/eApproval/CCDocument"
													...
													<table class="table align-middle table-hover">
														...
														<tbody>
															...
															<c:forEach items="${sanctnDocList }"
																var="ccSanctnDoc">
																<tr data-sanctnNo="${ccSanctnDoc.sanctnDocNo}">
																	<td>${ccSanctnDoc.sanctnDocNo }</td>
																	<td><c:if
																			test="${ccSanctnDoc.emrgncyYn eq 'Y' }">
																			<span class="mb-1 badge text-bg-danger">긴급</span>
																		</c:if> <a
																		href="${pageContext.request.contextPath }/eApproval/detail/${ccSanctnDoc.sanctnDocNo}?drafterId=${ccSanctnDoc.empNo}">
																			${ccSanctnDoc.sanctnTitle } </a></td>
																	<td><i class="ti ti-user fs-4 me-1"></i>${ccSanctnDoc.empNm }
																	</td>
																	<td>${ccSanctnDoc.deptNm }</td>
																	<td>${fn:substring(ccSanctnDoc.wrtDt, 0, 4) }-
																		${fn:substring(ccSanctnDoc.wrtDt, 5, 7) }-
																		${fn:substring(ccSanctnDoc.wrtDt, 8, 10) }</td>
																	<td><div class="mb-1 badge text-bg-success"
																			id="restore">완료</div></td>
																	<td><c:choose>
																			<c:when test="${ccSanctnDoc.hasFile eq 'Y' }">
