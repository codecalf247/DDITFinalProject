                  ...
                  <div class="card border-0 shadow-sm mail-detail-card">
                    <div class="card-body px-4 py-4 mail-header">
                      <h3 class="fw-semibold mb-3 d-flex align-items-center gap-2">
                        ...
                        <span><c:out value="${trashMail.emailTitle}"/></span>
                         <span class="badge text-bg-danger-subtle text-danger border border-danger-subtle">휴지통</span>
                      </h3>

                      <div class="row-item mb-2">
                        <div class="label">작성자</div>
                        <div><span class="chip"><i class="ti ti-user"></i><c:out value="${trashMail.empNm}"/></span></div>
                      </div>

                      <div class="row-item mb-2">
                        <div class="label">작성일</div>
                        <div class="text-body"><c:out value="${trashMail.emailWrtDt}"/></div>
                      </div>
                     ...
                     <div class="row-item">
						<div class="label">첨부파일</div>
							<div class="flex-grow-1">
								<c:choose>
									<c:when test="${not empty trashMail.fileList and trashMail.fileList[0].fileNo != 0}">
										<ul class="list-group list-group-flush rounded-3 border attach-list mb-2">
											<c:forEach var="file" items="${trashMail.fileList}">
                    ...
                    <div class="card-body px-4 py-4 mail-content">
                      <div class="mail-html">
                        <c:out value="${trashMail.emailCn}" escapeXml="false"/>
                      </div>
                    </div>
                  </div>
